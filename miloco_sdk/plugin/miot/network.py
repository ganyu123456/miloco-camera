...
from miloco_sdk.utils.types import InterfaceStatus, NetworkInfo
...
class MIoTNetwork:
    ...
    _IP_ADDRESS_LIST: list[str] = ["1.2.4.8", "8.8.8.8", "9.9.9.9"]  # CNNIC sDNS  # Google Public DNS  # Quad9
    _URL_ADDRESS_LIST: list[str] = ["https://www.bing.com", "https://www.google.com", "https://www.baidu.com"]
    ...
    def __call_network_info_change(self, status: InterfaceStatus, info: NetworkInfo) -> None:
